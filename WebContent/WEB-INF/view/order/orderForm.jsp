...
<body>
<form method="post">
상품1: ID - <input type="text" name="orderItem[0].itemId" />
개수 - <input type="text" name="orderItems[0].number" />
주의 - <input type="text" name="orderItems[0].remark" />
<br/>
상품2: ID - <input type="text" name="orderItem[1].itemId" />
개수 - <input type="text" name="orderItems[1].number" />
주의 - <input type="text" name="orderItems[1].remark" />
<br/>
상품3: ID - <input type="text" name="orderItem[2].itemId" />
개수 - <input type="text" name="orderItem[2].number" />
주의 - <input type="text" name="orderItem[2].number" />
<br/>
배송지:
